...
import { Menu as ContextMenu, Item as ContextMenuItem, Separator as ContextMenuSeparator, Submenu as ContextMenuSubmenu, contextMenu, animation } from "react-contexify"
...
const MoveSubmenu = memo(({ parent, load, uuid, darkMode, isMobile, items, lang }: MoveSubmenuProps) => {
    ...
    const loadFolders = useCallback((uuid: string, skipCache: boolean = false) => {
        fetchFolders(uuid, skipCache).then((data) => {
...
const ContextMenus = memo(({ darkMode, isMobile, items, lang }: ContextMenusProps) => {
    ...
    const [selected, selectedCount, fileCount, folderCount, canEdit, canPreview, favoriteEnabledCount, favoriteDisabledCount] = useMemo(() => {
        ...
        const canEdit: boolean = selectedCount == 1 && fileCount == 1 && folderCount == 0 && items.filter(item => item.selected && item.type == "file" && ["text", "code"].includes(getFilePreviewType(getFileExt(item.name)))).length == 1 && location.hash.indexOf("shared-in") == -1
        const canPreview: boolean = selectedCount == 1 && fileCount == 1 && folderCount == 0 && items.filter(item => item.selected && item.type == "file" && getFilePreviewType(getFileExt(item.name)) !== "none").length == 1
    ...
    return (
        <>
            ...
            >
                ...
                {
                    location.hash.indexOf("trash") == -1 && location.hash.indexOf("shared-in") == -1 && location.pathname.indexOf("/f/") == -1 && (
                        <>
                            {
                                selectedCount == 1 && (
                                    <ContextMenuItem
                ...
                {
                    fileCount == 1 && folderCount == 0 && location.hash.indexOf("trash") == -1 && location.hash.indexOf("shared-in") == -1 && location.pathname.indexOf("/f/") == -1 && (
                        <>
                            <ContextMenuItem onClick={() => versions()}>
                                {i18n(lang, "versions")}
                            </ContextMenuItem>
                            <ContextMenuSeparator />
                        </>
                ...
                {
                    fileCount == 0 && location.hash.indexOf("trash") == -1 && location.hash.indexOf("shared-in") == -1 && location.pathname.indexOf("/f/") == -1 && (
                        <ContextMenuSubmenu
                ...
                {
                    favoriteEnabledCount > 0 && location.hash.indexOf("trash") == -1 && location.hash.indexOf("shared-in") == -1 && location.pathname.indexOf("/f/") == -1 && (
                        <ContextMenuItem
                ...
                {
                    favoriteDisabledCount > 0 && location.hash.indexOf("trash") == -1 && location.hash.indexOf("shared-in") == -1 && location.pathname.indexOf("/f/") == -1 && (
                        <ContextMenuItem
                ...
                {
                    ((favoriteEnabledCount + favoriteDisabledCount) > 0 || fileCount == 0) && location.hash.indexOf("trash") == -1 && location.hash.indexOf("shared-in") == -1 && location.pathname.indexOf("/f/") == -1 && (
                        <ContextMenuSeparator />
                    )
                }
                {
                    (fileCount == 1 || folderCount == 1) && location.hash.indexOf("trash") == -1 && location.hash.indexOf("shared-in") == -1 && location.pathname.indexOf("/f/") == -1 && (
                        <>
                ...
                {
                    (fileCount + folderCount) > 0 && location.hash.indexOf("trash") == -1 && location.hash.indexOf("shared-in") == -1 && location.pathname.indexOf("/f/") == -1 && (
                        <>
                            {
                ...
                }
                {
                    location.hash.indexOf("trash") !== -1 && location.pathname.indexOf("/f/") == -1 && (
                        <>
                            <ContextMenuItem
                                onClick={() => restoreFromTrash(items.filter(item => item.selected))}
                            >
                                {i18n(lang, "restore")}
                            </ContextMenuItem>
                            <ContextMenuSeparator />
