                    ...
                    >
                        {
                            (Object.keys(currentUploads).length > 0 && Object.keys(currentDownloads).length > 0) ? (
                                <>
                                    {i18n(lang, "transferringItems", true, ["__COUNT__"], [(Object.keys(currentUploads).length + Object.keys(currentDownloads).length).toString()])}
                                </>
                            ) : Object.keys(currentUploads).length > 0 ? (
                                <>
                                   {i18n(lang, "uploadingItems", true, ["__COUNT__"], [(Object.keys(currentUploads).length + Object.keys(currentDownloads).length).toString()])}
                                </>
                            ) : (
                                <>
                                   {i18n(lang, "downloadingItems", true, ["__COUNT__"], [(Object.keys(currentUploads).length + Object.keys(currentDownloads).length).toString()])}
                                </>
                            )
                        }
                    </AppText>
...
export const show = (type: CustomToastTypes, message: string = "", position: ToastPosition = "bottom", duration: number = 5000): ToastId => {    
    ...
    const id = toast({
        render: ({ id, onClose }) => (
            getToastElement(type, message, id as ToastId, onClose)
        ),
