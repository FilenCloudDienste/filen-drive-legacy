					...
					<Button
						...
						onClick={() => {
							db.get("acknowledgedAnnouncements")
								.then(acknowledgedAnnouncementsDb => {
...
const Announcements = memo(({ darkMode, isMobile, cfg }: AnnouncementsProps) => {
	...
	if (
		...
		typeof acknowledgedAnnouncements == "undefined"
	) {
		return null
	}
	...
	return (
		<>
			{cfg.announcements
				.filter(a => a.active && typeof acknowledgedAnnouncements[a.uuid] == "undefined")
