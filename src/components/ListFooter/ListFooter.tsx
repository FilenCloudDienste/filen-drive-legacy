...
const ListFooter = memo(({ darkMode, isMobile, items, loadingItems, listScrollState, windowWidth, sidebarWidth, lang }: ListFooterProps) => {
    const location = useLocation()

    const [selected, selectedCount, fileCount, folderCount, canEdit, canPreview, favoriteEnabledCount, favoriteDisabledCount, selectedItemsSize] = useMemo(() => {
        ...
        return [selected, selectedCount, fileCount, folderCount, canEdit, canPreview, favoriteEnabledCount, favoriteDisabledCount, selectedItemsSize]
    }, [items, location])

    if(loadingItems || items.length == 0 || (listScrollState.scrollHeight - listScrollState.clientHeight - 50) < listScrollState.scrollTop){
        ...
        >
            ...
            >
                <AppText
                    ...
                    noOfLines={1}
                >
                    {i18n(lang, "listFooterSelected", true, ["__COUNT__", "__TOTAL__"], [selectedCount.toString(), items.length.toString()])}
                </AppText>
                <Flex
                    width="auto"
                    height="auto"
