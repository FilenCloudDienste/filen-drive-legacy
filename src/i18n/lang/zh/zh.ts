const zh: {
    ...
    forgotPasswordSendInstructions: "忘记密码发送指示",
    goBack: "返回",
    ...
    storageUsedInfo: "__USED__ 中 __MAX__ 使用的",
    storageUsedFilesAndFolders: "文件 __USED__",
    storageUsedVersionedFiles: "有版本的文件 __USED__",
    storageUsedFree: "可用的存储空间 __FREE__",
    avatar: "头像",
    edit: "编辑",
    ...
    enable: "启用",
    recoveryKeys: "恢复密钥",
    recoveryKeysInfo: "请安全保存您的恢复密钥。这是在双因素认证设备丢失的情况下恢复您的账户的唯一方法.",
    close: "关闭",
    disable2FA: "禁用双因素认证",
    disable: "禁用",
    sharedWithMe: "与我共享",
    ...
    remove: "删除",
    stopSharing: "停止分享",
    cookieConsent: "本网站使用cookies来衡量和改善您的体验.",
    accept: "同意",
    optOut: "选择退出",
    onlyNeeded: "仅需的",
    pleaseChooseDiffName: "请选择一个不同的名字",
    newFolderName: "名字",
    itemsMovedToTrash: "__COUNT__ 移入回收站的项目",
    couldNotMoveToTrash: "无法移动 __NAME__ 到回收站: __ERR__",
    deleteModalSure: "你确定你要删除 __COUNT__ 项目?",
    deletePermModalSure: "你确定你要永久删除 __COUNT__ 项目? 此行为不能被撤销!",
    itemsDeletedPerm: "__COUNT__ 项目已永久删除",
    ...
    listEmpty_11: "回收站什么都没有",
    listEmpty_12: "一旦你标记了要删除的文件或文件夹，它们将出现在这里",
    listEmpty_13: "还没有上传文件或文件夹",
    listEmpty_14: "在这里拖放文件或文件夹，或按下面的按钮",
    listFooterSelected: "__COUNT__ 所选的 __TOTAL__",
    name: "名",
    size: "大小",
    lastModified: "最后修改",
    moveModalBtn: "移动 __COUNT__ 项目到 __DEST__",
    file: "文件",
    ctrlPlusS: "CTRL + S",
    exit: "退出",
    ...
    expire_14d: "14天",
    expire_30d: "30天",
    addingItemsToPublicLink: "将项目添加到公共链接中",
    addingItemsToPublicLinkProgress: "将 __LEFT__ 添加到公共链接中",
    enabled: "已启用",
    disabled: "已关闭",
    copied: "已复制",
    publicLinkDownloadBtn: "下载按钮已启用",
    publicLinkPassword: "密码（留空表示禁用）",
    removedSharedItems: "删除 __COUNT__ 已共享文件",
    couldNotRemoveSharedItems: "无法删除 __NAME__: __ERR__",
    removeSharedItemsModalInfo: "你确定你要删除 __COUNT__ 项目? 你将无法再访问它们。",
    renameNewName: "新名称",
    ...
    sharedWith: "分享给",
    sharingItems: "分享项目",
    sharingItemsProgress: "分享 __LEFT__ 项目",
    itemsSharedWith: "__COUNT__ 项目与 __EMAIL__ 分享",
    shareReceiver: "接收者的Filen账户电子邮件",
    upgrade: "升级",
    stoppedSharingItems: "停止共享 __COUNT__ 项目",
    couldNotStopSharingItem: "无法停止分享 __NAME__: __ERR__",
    stopSharingModalSure: "你确定你要停止分享 __COUNT__ 项目吗? 其他各方将不再能够访问它们。",
    aboutRemaining: "剩余时间 __TIME__ ",
    transferringItems: "转移 __COUNT__ 项目",
    uploadingItems: "正在上传 __COUNT__ 项目",
    downloadingItems: "正在下载 __COUNT__ 项目",
    new: "新的",
    resume: "重新开始",
    pause: "暂停",
    stop: "停止",
    ...
    creatingFoldersProgress: "新建 __LEFT__ 文件夹",
    current: "目前的",
    create: "新建",
    changingColor: "改变颜色为 __COUNT__ 项目",
    couldNotChangeColor: "无法改变颜色为 __NAME__: __ERR__",
    eventFileUploaded: "文件已上传",
    eventFileVersioned: "文件已版本化",
    ...
    eventLogin: "登录",
    eventDeleteVersioned: "版本化文件和文件夹已删除",
    ...
    eventFileVersionedInfo: "__NAME__ 已版本化",
    ...
    eventRemovedSharedInItemsInfo: "__COUNT__ 来自 __EMAIL__ 共享的项目已移除",
    eventRemovedSharedOutItemsInfo: "__COUNT__ 向 __EMAIL__ 共享的项目已删除",
    favoritingItems: "收藏 __COUNT__ 项目",
    unfavoritingItems: "取消收藏 __COUNT__ 项目",
    couldNotChangeFavStatus: "无法为 __NAME__ 改变收藏状态: __ERR__",
    pleaseChooseDiffDest: "请选择一个不同的目标",
    movingItems: "移动 __COUNT__ 项目",
    folderExistsAtDest: "在目的地已经存在一个名字为 __NAME__ 的文件夹。",
    couldNotMoveItem: "无法移动 __NAME__: __ERR__",
    restoringItems: "正在恢复 __COUNT__ 项目",
    ...
    passwordResetSuccess: "密码已更改。请从所有任意设备重新登录.",
    resetPasswordBtn: "重置密码",
    publicLinkDisabled: "已禁用公共链接",
    expireAfter: "过期于",
    exportMasterKeys: "导出主密钥",
    export: "导出",
    resetPasswordCheckbox: "我明白，由于零知识端到端加密的工作原理，在没有导出主密钥的情况下重设我的密码，将无法访问在我账户上存储的所有数据.",
    ...
    referInfo: "通过邀请他人获得高达 __STORAGE__ 的存储量",
    referInfo2: "你每邀请一位朋友加入Filen,你就会得到 __STORAGE__ - 你的朋友也会得到 __OTHER_STORAGE__. 您的朋友可以注册他们所选择的订阅，而您可以获得佣金。佣金支付的门槛是 __THRESHOLD__€. 你的比率是 __RATE__%",
