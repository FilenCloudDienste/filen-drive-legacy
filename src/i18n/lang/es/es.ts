const es: {
    ...
    abuseReportModalInfoPlaceholder: "Por favor ofrezcanos todos los detalles para que podamos tomar acción apropiada (opcional)",
    send: "Enviar",
    abuseReportModalReason: "Por favor elija un motivo",
    avatarUploadMaxFileSize: "El tamaño de archivo no puede exceder los 3MB",
    storageUsed: "Almacenamiento usado",
    storageUsedInfo: "__USED__ de __MAX__ usado",
    storageUsedFilesAndFolders: "Archivos __USED__",
    storageUsedVersionedFiles: "Archivos versionados __USED__",
    storageUsedFree: "Gratis __FREE__",
    avatar: "Avatar",
    edit: "Editar",
    ...
    update: "Actualizar",
    cancel: "Cancelar",
    noSubs: "No tiene subscripciones activas.",
    noInvoices: "No tiene facturas aún.",
    ...
    planTerms_lifetime: "Toda la vida",
    ...
    publicLinkPassword: "Contraseña (dejar vacío para desactivar)",
    ...
    shareReceiver: "Correo electrónico de la cuenta de Filen del destinatario",
    upgrade: "Mejorar",
    ...
    aboutRemaining: "Aproximádamente __TIME__ restantes",
    ...
    eventDeleteUnfinished: "Subidas no finalizadas eliminadas",
    ...
    receivedBonusStorage: "Almacenamiento extra recibido total",
    referInfo: "Reciba hasta __STORAGE__ de almacenamiento invitando a otros",
    referInfo2: "Por cada amigo que invite a Filen recibirá __STORAGE__ - y su amigo también recibe __OTHER_STORAGE__. Su amigo puede registrarse para una suscripción de su elección y usted ganará una comisión. El límite de pago por comisión es de __THRESHOLD__€. Su porcentaje es __RATE__%.",
