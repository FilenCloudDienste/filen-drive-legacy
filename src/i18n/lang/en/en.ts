const en: {
    ...
    exportMasterKeysInfo: "Exporting your master keys makes it possible to recover your account without data loss in case you forget your password. Please make sure to export your new master keys every time you change your password.",
    import: "Import",
    invite: "Invite",
