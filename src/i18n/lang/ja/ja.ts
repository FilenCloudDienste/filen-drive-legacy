const ja: {
	...
	toggleParticipantWritePermissionsClick: "メモの編集ができます。クリックすると見るだけを許可します。",
	toggleParticipantReadPermissionsClick: "メモを見ることができます。クリックすると編集を許可します。",
	...
	deleteNote: "ノートを削除",
	toggleParticipantWritePermissions: "メモの編集ができます。クリックすると見るだけを許可します。",
	toggleParticipantReadPermissions: "メモを見ることができます。クリックすると編集を許可します。",
	...
	leave: "メンバーをやめる",
	leaveNote: "ノートのメンバーをやめる",
	leaveNoteWarning: "このノートのメンバーをやめますか？キャンセルはできません。",
	...
	chatMessageDeleteWarning: "メッセージを撤回しますか？撤回するとキャンセルはできません。",
