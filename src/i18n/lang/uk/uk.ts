const uk: {
    ...
    abuseReportModalInfo: "Використовуйте цю форму, щоб повідомити про неприйнятні, незаконні або інші шкідливі файли, до яких надається спільний доступ.",
    yourEmailAddress: "Ваша адреса електронної пошти",
    abuseReportModalInfoPlaceholder: "Будь ласка, надайте нам всі деталі, щоб ми могли вжити відповідних заходів (необов'язково)",
    send: "Відправити",
    ...
    changeEmailPleaseConfirm: "Будь ласка, підтвердіть вашу нову адресу електронної пошти, перейшовши за посиланням, надісланим на неї",
    ...
    areYouSureDeleteAllVersioned: "Ви впевнені, що хочете видалити всі версоновані файли? Ця дія не може бути скасована!",
    ...
    deleteAccountConfirm: "Будь ласка, підтвердіть видалення облікового запису, перейшовши за посиланням, надісланим на вашу електронну пошту",
    areYouSureDeleteAccount: "Ви впевнені, що хочете видалити свій обліковий запис? Ми надішлемо посилання для підтвердження на вашу електронну пошту.",
    ...
    recoveryKeysInfo: "Будь ласка, зберігайте ключ відновлення у надійному місці. Це єдиний спосіб відновити свій обліковий запис у разі втрати пристрою для двофакторної аутентифікації.",
    close: "Закрити",
    ...
    buyRecurringInfo: "Купуючи тарифний план, ви дозволяєте Filen автоматично стягувати з вас плату за кожен розрахунковий період, поки ви не скасуєте його. Ви можете скасувати в будь-який час через сторінку свого облікового запису. Часткове відшкодування не здійснюється.",
    buyLifetimeInfo: "Купуючи тарифний план, ви дозволяєте Filen стягувати плату згідно вашого способу оплати. Часткове відшкодування не здійснюється.",
    ...
    removeSharedItemsModalInfo: "Ви впевнені, що хочете видалити __COUNT__ елементів? Ви більше не зможете отримати до них доступ.",
    ...
    stopSharingModalSure: "Ви впевнені, що хочете вилучити зі спільного доступу __COUNT__ об'єктів? Ви більше не зможете отримати до них доступ.",
    ...
    registrationEmailInstructions: "Для завершення реєстрації, будь ласка, підтвердіть свою адресу електронної пошти. Посилання з інструкціями надіслано вам на пошту.",
    ...
    maxStorageReachedInfo: "Ви вичерпали свій максимальний обсяг сховища. Будь ласка, покращіть свій обліковий запис, щоб завантажити більше файлів.",
    ...
    export: "Експортувати",
    resetPasswordCheckbox: "Я розумію, що скинувши пароль не експортувавши майстер-ключі, я зроблю недоступними всі дані, що зберігаються в моєму обліковому записі, через те, як працює наскрізне шифрування з нульовим знанням.",
    invalidAuthVersion: "Неправильна версія аутентифікації",
    recoveryMasterKeysInput: "Експортовані майстер-ключі",
    exportMasterKeysInfo: "Експорт майстер-ключів дає можливість відновити обліковий запис без втрати даних у випадку, якщо ви забули пароль. Будь ласка, обов'язково експортуйте нові майстер-ключі щоразу після зміни пароля.",
    import: "Імпортувати",
    invite: "Запросити",
    ...
    requestPayoutInfo: "Ми відправимо вашу зароблену партнерську комісію на вказану Bitcoin-адресу протягом 1-7 робочих днів.",
    ...
    referInfo2: "За кожного друга, якого ви запросите до Filen, ви отримаєте __STORAGE__ - а ваш друг також отримає __OTHER_STORAGE__. Ваш друг може оформити підписку на обраний ним тарифний план, а ви зароблятимете комісійні. Поріг для виплати комісії становить __THRESHOLD__€. Ваша частка складає __RATE__%.",
